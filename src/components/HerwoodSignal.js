...
const NEWSAPI_KEY = process.env.NEXT_PUBLIC_NEWSAPI_KEY || 'b636fcdea3fd49b28a49297d9c34d720'
...
async function fetchNews(query) {
  const url = `https://newsapi.org/v2/everything?q="${encodeURIComponent(query)}"&language=en&sortBy=publishedAt&pageSize=5&apiKey=${NEWSAPI_KEY}`
  try {
